      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">CareerPath</h3>
            <p className="text-gray-300 mb-4">
              Empowering students to discover their ideal career paths through personalized course recommendations and comprehensive guidance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/career-finder" className="text-gray-300 hover:text-blue-400 transition-colors">Career Finder</Link></li>
              ...
              <li><Link to="/ai-tools" className="text-gray-300 hover:text-blue-400 transition-colors">AI Tools</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 CareerPath. All rights reserved. Empowering students to find their perfect career path.
          </p>
        </div>
      </div>
    </footer>
